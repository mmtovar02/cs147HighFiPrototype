...
export default function Task(props) {
  ...
  return (
    <TouchableOpacity
      style={props.complete ? styles.completedTask : styles.task}
      onPress={() => {
        props.navigation ? props.navigation.navigate("Tester") : null;
      }}
    >
      <View>
