...
export default function Header(props) {
  ...
  const getLeftComponents = () => {
    if (props.includeBackArrow) {
      return (
        <TouchableOpacity
          onPress={props.onBackArrowPress}
  ...
  const getRightComponents = () => {
    if (props.rightButtonLabel) {
      ...
      return <View style={styles.rightButton}>{props.rightButton}</View>;
    }
  };
        ...
        {props.facilitatorSubtitle ? (
          <View style={{ flexDirection: "row", alignSelf: "center" }}>
            <FontAwesome5
              ...
              size={16}
              color="#ffa899"
              style={styles.facilitatorSubtitleIcon}
            />
            <Text style={styles.facilitatorSubtitle}>
