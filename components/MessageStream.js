  ...
  return (
    <View style={styles.container}>
      ...
      <Message
        ...
        label="Lily"
      />
      <Message message="I can relate" label="Cole" />
      <Message message="It's gotten better but I used to struggle a lot with going to public places with a lot of people in them" />
      <Message
